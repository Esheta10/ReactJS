...
const EmployeePopup = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full z-20 flex items-center justify-center mt-15 text-2xl bg-black/80">
      <fieldset className="fieldset bg-base-300 border-base-300 rounded-box w-xs border p-7">
